...
// GetRespCode returns the respCode of http responce
func (this *Page) GetRespCode() int {
	return this.respCode
}

// SetRespCode save the respCode of http responce
func (this *Page) SetRespCode(respCode int) {
